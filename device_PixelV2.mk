...
$(call inherit-product-if-exists, vendor/lava/PixelV2/PixelV2-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/lava/PixelV2/overlay
PRODUCT_PACKAGE_OVERLAYS += device/lava/PixelV2/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/lava/PixelV2
